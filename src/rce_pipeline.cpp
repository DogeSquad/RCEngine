...
namespace rce 
{
	...
	void RCEPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo, uint32_t width, uint32_t height)
	{
		...
		// How is NDC mapped to the output image?
		...
		// What part of the output image is actually modified?
		...
		configInfo.rasterizationInfo.polygonMode = VK_POLYGON_MODE_LINE; //VK_POLYGON_MODE_FILL;
